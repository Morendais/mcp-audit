...
func runInteractiveTUI() error {
	...
	fmt.Println("\033[1;37m║                     mcp-hunter — Zero-Config Security Auditor                     ║\033[0m")
	fmt.Println("\033[1;36m╚═══════════════════════════════════════════════════════════════════════════════════╝\033[0m")
	fmt.Println()
	...
	if len(servers) == 0 {
		...
		fmt.Println("     \033[1;32mmcp-hunter scan --exec \"npx -y @modelcontextprotocol/server-filesystem /tmp\"\033[0m")
		fmt.Println()
		fmt.Println("  2. Audit a remote SSE server:")
		fmt.Println("     \033[1;32mmcp-hunter remote --sse http://localhost:8000/sse\033[0m")
		fmt.Println()
		fmt.Println("  3. Specify a configuration file explicitly:")
		fmt.Println("     \033[1;32mmcp-hunter scan --config ./claude_desktop_config.json\033[0m")
		fmt.Println()
		return nil
	}
